...
class ValidatorTests(unittest.TestCase):
    ...
    def test_placeholder_content_fails(self) -> None:
        ...
        path.write_text(path.read_text(encoding="utf-8").replace("Cross-trade content patterns under test", "TODO services"), encoding="utf-8")
        report = self.validate()
        self.assertFalse(report.passed)
    ...
    def test_unlisted_html_and_wrong_origin_canonical_are_rejected(self) -> None:
        ...
        index.write_text(
            index.read_text(encoding="utf-8").replace(
                "https://contractor-v6-test.pages.dev/",
                "https://attacker.test/",
                1,
            ),
            encoding="utf-8",
